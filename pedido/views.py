...
class SalvarPedido(View):
    ...
    def post(self, *args, **kwargs):
        ...
        # Verificação de valor para pagamento em dinheiro
        valor_dinheiro = None
        ...
        if isinstance(carrinho, str):
            carrinho = json.loads(carrinho)  # Converte string JSON para dicionário
        ...
        pedido = Pedido(
            ...
            # Nota: Assegure-se de que 'valor_pagamento' seja um campo existente no modelo Pedido
